            ...
            <div class="single-slider slider-height d-flex align-items-center"
                ...
                <div class="container">
                    ...
                    <div class="row">
                        <div class="col-xl-8">
                            <!-- form -->
                            <form action="{{ route('job-list') }}" class="search-box" id="search-form">
                                ...
                                <div class="search-form">
                                    <a href="#" onclick="event.preventDefault();document.getElementById('search-form').submit();">Find job</a>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-4 col-sm-6">
                        <div class="single-services text-center mb-30">
                            ...
                            <div class="services-cap">
                                <h5><a href="{{ route('job-list', $item->id) }}">{{$item->category_name}}</a></h5>
                                <span>({{count($item->jobs)}})</span>
                            </div>
                        </div>
                    </div>
                @endforeach
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="browse-btn2 text-center mt-50">
                        <a href="{{ route('job-list') }}" class="border-btn2">Browse All Sectors</a>
                    </div>
                </div>
            </div>
        </div>
                        ...
                        <div class="single-job-items mb-30">
                            <div class="job-items">
                                <div class="company-img">
                                    <a href="{{ route('job-detail', $job->id) }}"><img width="85px" src="{{ URL::to('/images/' . $job->image_url) }}" alt=""></a>
                                </div>
                                <div class="job-tittle">
                                    <a href="{{ route('job-detail', $job->id) }}"><h4>{{ $job->title }}</h4></a>
                                    <ul>
                                        <li>{{ $job->user->name }}</li>
                            ...
                            <div class="items-link f-right">
                                <a href="{{ route('job-detail', $job->id) }}">{{ $job->job_type == 1 ? 'Full time' : 'Part time' }}</a>
...
{{--                                <div class="testimonial-founder  ">--}}
{{--                                    <div class="founder-img mb-30">--}}
{{--                                        <img src="{{ asset('user/assets/img/testmonial/testimonial-founder.png') }}" alt="">--}}
{{--                                        <span>Margaret Lawson</span>--}}
{{--                                        <p>Creative Director</p>--}}
{{--                                    </div>--}}
{{--                                </div>--}}
